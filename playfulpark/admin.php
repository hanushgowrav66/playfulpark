...
<html lang="en">
<head>
	<title>Playful Park - Admin Login</title>
	<meta charset="utf-8">
     ...
     <div class="site-wrapper">
      ...
      <div class="container inner cover">
          <div class="inner cover">
            <h1 class="cover-heading"><u>Admin Login</u></h1>
          </div><br>
      ...
      <form action="" method="post" name="login" class="form" id="submit-form" >  
              ...
              <br><br>
              <!-- <p class="lead">Not registered yet? <a href='adminreg.php' class="btn btn-lg btn-default">Register Here</a></p> -->
            </form>
        </div>
      </div>
    </div>
